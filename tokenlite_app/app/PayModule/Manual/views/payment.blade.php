...
<div class="popup-body">
    ...
    <div class="popup-content">
        ...
        <form action="{{ route('payment.manual.update') }}" method="POST" id="payment-confirm" class="validate-modern" autocomplete="off">
            ...
            <p class="mt-1"><a class="link" href="{{ route('user.token-list') }}">{{ __("I'll provide wallet address later") }}</a></p>
            @endif
        </form>
        <div class="gaps-2-5x"></div>
        <div class="note note-info note-plane">
            <em class="fas fa-info-circle"></em> 
            <p>{{__('Please send payment within 48 hours. Contact us if your preferred payment method is not listed')}}</p>
        </div>
        <div class="gaps-1x"></div>
