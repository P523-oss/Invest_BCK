    ...
    public static function default_pages($get = null)
    {
        $data = [
            ...
            'distribution' => [
                ...
                'slug' => 'distribution',
                'custom_slug' => 'token-distribution',
                'menu_title' => 'Token Distribution',
    ...
    public static function default_email_template($get = null)
    {
        $data = [
            ...
            'kyc-approved-email' => [
                ...
                'subject' => 'KYC Verified: Contribute in [[site_name]] Token Sale',
                'greeting' => 'Hello [[user_name]],',
