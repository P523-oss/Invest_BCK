        ...
        $global = [
            ///// MESSAGES /////
              ...
              "messages.email.reset" => [
                "text" => "Something is wrong! We are unable to send reset link to your email. Please! contact with administrator via :email.",
                "pages" => "messages, global",
                "panel" => "any",
                "load" => 1
              ],
              "messages.email.verify" => [
                "text" => "Something is wrong! We are unable to send the verification link to your email. Please! contact with administrator via :email.",
                "pages" => "messages, global",
                "panel" => "any",
                "load" => 1
              ],
              "messages.email.password_change" => [
                "text" => "Something is wrong! We are unable to send the confirmation link to your email. Please! contact with administrator via :email.",
                "pages" => "messages, global",
                "panel" => "any",
                "load" => 1
              ],
              ...
              "messages.verify.success.subhead" => [
                ...
                "text" => "You've successfully verified your email address. Step 1 of our 2 step sign-up process is now complete.",
                "pages" => "messages, global",
                "panel" => "any",
                "load" => 1
              ],
              "messages.verify.success.msg" => [
                ...
                "text" => "Please sign-in toproceed to the 2nd stage of account creation.",
                "pages" => "messages, global",
                "panel" => "any",
                "load" => 1
              ],
              ...
              "messages.ico_not_setup" => [
                "text" => "Token Sales opening soon, Please check after sometimes.",
                "pages" => "messages, global",
                "panel" => "any",
                "load" => 1
              ],
