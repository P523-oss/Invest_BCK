                ...
                <div class="kyc-status card mx-lg-4">
                    <div class="card-innr">
                        ...
                        <div class="status status-empty">
                           ...
                           <a href="{{ route('user.kyc.application') }}?state=new" class="btn btn-primary">{{__('Click here to complete our internal KYC process')}}</a> <br/><br/><br/>
                           {{-- <a href="https://verify-with.blockpass.org/?clientId=tokenizer_ba098&serviceName=Tokenizer&env=prod?state=new" target="_blank" class="btn btn-primary">{{__('Click here to complete Blockpass\' KYC verification')}}</a>
                           <br />(you will be redirected to their site) --}}

                           {{--  <section class="widget"><div class="container"><button id="blockpass-kyc-connect"><div class="lds-dual-ring hidden"></div>
                                <img id="image_logo" class="" src="">
                                <span style="font-weight: 500; text-transform: uppercase;">{{__('Click here to complete your KYC')}}</span></button></div></section> --}}
                        </div>
                        @endif
                        {{-- IF SUBMITED @Thanks --}}
