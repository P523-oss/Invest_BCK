...
<div class="card content-area content-area-mh">
    <div class="card-innr">
        ...
        {{-- <div class="row">
            <div class="col-md-12">
                <div class="float-right position-relative input-item mr-3">
                    <input name="save_activity" class="input-switch input-switch-sm" type="checkbox" id="showAllTokens">
                    <label for="activitylog">{{__('Show all tokens')}}</label>
                </div>    
            </div>    
        </div>     --}}
        <div class="row">
            ...
            <tbody>
                ...
                <tr class="data-item tnx-item-{{ $trnx->id }}">
                    ...
                    <td class="data-col dt-token">
                        ...
                        <span class="badge badge-info">{{ $trnx->tnxToken->token_symbol }}</span>
                    </td>
                    ...
                    <td class="data-col dt-usd-amount">
                        ...
                        <span class="sub sub-symbol">{{ base_currency(true) }} <em class="fas fa-info-circle" data-toggle="tooltip" data-placement="bottom" title="1 {{ $trnx->tnxToken->token_symbol }} = {{ to_num($trnx->base_currency_rate, 'max').' '.base_currency(true) }}"></em></span>
                        @endif
                    </td>
