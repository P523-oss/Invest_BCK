...
@section('title', __('Tokens Balance'))
@php
$has_sidebar = true;
$symbol = token_symbol();
...
<div class="content-area card">
    <div class="card-innr">
        ...
        <div class="card-head">
            ...
            <h4 class="card-title">{{ __('My Tokens') }}</h4>
        </div>
                ...
                <div class="row guttar-vr-15px align-items-center">
                    <div class="col-md-12">
                        <div class="total-block">
                            ...
                            <span class="total-amount-lead"></span>{!! ($TAC->tableUserBalance) !!}
                                @if($TAC->pending > 0)
                    ...
                    <div class="col-md-12 text-md-lefy">
                        <a href="{{ route('user.token') }}" class="btn btn-primary">{{ __('Buy More Tokens') }}</a>
                    </div>
                </div>
            </div>
