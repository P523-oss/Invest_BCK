...
<div class="page-ath-form">
    ...
    <form class="register-form" method="POST" action="{{ route('register') }}" id="register">
        ...
        <div class="input-item">
            <input type="phone" placeholder="{{__('Your Phone')}}" class="input-bordered{{ $errors->has('phone') ? ' input-error' : '' }}" name="phone" value="{{ old('phone') }}"data-msg-required="{{ __('Required.') }}" data-msg-phone="{{ __('Enter valid phone number.') }}" required>
        </div>
        <div class="input-item">
