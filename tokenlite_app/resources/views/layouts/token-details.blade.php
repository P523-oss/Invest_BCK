...
<ul class="data-details-list">
    ...
    <li>
        ...
        <div class="data-details-des">
            <span>{{ to_num($transaction->tokens, 'zero', '', false) }} {{ $transaction->tnxToken->token_symbol }}</span>
        </div>
    </li>
    @endif
    @if($transaction->tnx_type=='purchase')
    <li>
        ...
        <div class="data-details-des">
            <span>{{ to_num($transaction->total_bonus, 'zero', '', false) }} {{ $transaction->tnxToken->token_symbol }}</span>
    ...
    <li>
        ...
        <div class="data-details-des">
            <span><strong>{{ to_num($transaction->total_tokens, 'zero', '', false) }} {{ $transaction->tnxToken->token_symbol }}</strong></span>
            <span>(T+B)</span>
        </div>
    </li>
    <li>
    ...
    <li>
        ...
        <div class="data-details-des">
            <span><strong class="text-danger">{{ round($transaction->total_tokens, min_decimal()) }} {{ $transaction->tnxToken->token_symbol }}</strong></span>
        </div>
    </li>
    <li>
