...
<img height="50" src="{{ site_whitelabel('logo') }}" srcset="{{ site_whitelabel('logo') }}" alt="{{ site_whitelabel('name') }}">
                            @endif
                        </a>
                    </div>
                    <ul class="topbar-nav">
                ...
                <div class="navbar-innr">
                    <ul class="navbar-menu" id="main-nav">
                        ...
                        <li {!! ((is_page('stages'))? ' class="active"' : '') !!}>
                            <a href="{{ route('admin.tokens.settings') }}"><em class="ikon ikon-coins"></em>Tokens List</a>
                        </li>
                        @endif
                        {{-- @if(gup('stage'))
                        <li{!! ((is_page('stages'))? ' class="active"' : '') !!}>
                            <a href="{{ route('admin.stages') }}"><em class="ikon ikon-coins"></em> Token Sale Stage</a>
                        </li>
                        @endif --}}
                        @if(gup('setting'))
                        <li class="has-dropdown"><a class="drop-toggle" href="javascript:void(0)"><em class="ikon ikon-settings"></em> Settings</a>
                            <ul class="navbar-dropdown">
                                <li><a href="{{ route('admin.stages.settings') }}">Token Sale Setting</a></li>
...
@php
    ...
    $route_urls = [
        ...
        'view_token_url' => 'admin.ajax.tokens.view',
