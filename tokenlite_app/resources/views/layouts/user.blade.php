...
<body class="user-dashboard page-user theme-modern">
    ...
    <div class="topbar-wrap">
        <div class="topbar is-sticky" style="{{bgColor(Auth::user()->symbol)}}">
            ...
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a class="topbar-logo" href="{{ url('/') }}">
                        ...
                        {{-- <img height="40" src="/images/Launchpad-light.svg" alt="Blockx"> --}}
                        <img height="40" src="{{ tokens(Auth::user()->symbol) }}" >
                    </a>
                    <ul class="topbar-nav">
                        <li class="topbar-nav-item relative">
...
{{--                        @endif--}}
                    ...
                    <ul class="navbar-btns">
                        @if(!Auth::user()->selfCertified())
                            <li><a href="{{ route('user.selfcertify') }}" class="btn btn-sm btn-outline btn-light"><em class="text-primary ti ti-files"></em><span>{{__('Self Certify')}}</span></a></li>
                        ...
                        @elseif(Auth::user()->self_cert_form == "complete")
                            {{-- <li><a href="javascript:void(0)" class="btn btn-sm btn-outline btn-light" id="blockpass-kyc-connect"><em class="text-primary ti ti-files"></em><span>KYC</span></a></li> --}}
                            <li><a href="javascript:void(0)" data-toggle="modal" data-target="#modal-select-kyc" class="select-kyc btn btn-sm btn-outline btn-light"><em class="text-primary ti ti-files"></em><span>KYC</span></a></li>
                        @else
            ...
            <div class="modal-content">
                ...
                <div class="popup-body popup-body-md">
                    <h4 class="popup-title">{{__('Choose KYC')}}</h4>
                       ...
                       <p style="width:47%; text-align:center;">OR</p>
                        <p><button id="blockpass-kyc-connect" class="btn btn-sm btn-outline btn-light"><em class="text-primary ti ti-files"></em><span>Connect with Blockpass</span></button></p>
{{--                        @if(Auth::user()->self_cert_form != 'complete')--}}
                            {{-- <p><a href="{{ route('user.selfcertify') }}" class="btn btn-sm btn-outline btn-light"><em class="text-primary ti ti-files"></em><span>Self Certification</span></a></p> --}}
{{--                        @endif--}}
                    <!-- <script>
                            const blockpass = new BlockpassKYCConnect('tokenizer_99ef3')
...
$('document').ready(function(){
    f_blockpass()
    document.cookie = `name=; expires=Wed, 31 Oct 2012 08:50:17 GMT; path=/`;
});

const f_blockpass = function(){
  let blockpass = new BlockpassKYCConnect('tokenizer_99ef3')
    blockpass.startKYCConnect()
    blockpass.on('KYCConnectSuccess', () =>{
            //add code that will trigger when data have been sent. ex:
            // alert('Success!')
