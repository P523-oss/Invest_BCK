        ...
        <div class=" sd modal-content">
            ...
            <div class="popup-body popup-body-md">
                ...
                <form action="javascript:void(0)" method="POST" autocomplete="off" id="adjust_token_cal">
                    ...
                    <div class="row">
                        <div class="col-12">
                             <p>User requested to purchase <strong>{{$trnx->total_tokens.' '.token_symbol($trnx->token_id)}}</strong> Token and payment amount <strong>{{ to_num($trnx->amount, 'max').' '.strtoupper($trnx->currency) }}</strong>. Please update received amount accrodingly if you received less or more than payment amount.</p>
