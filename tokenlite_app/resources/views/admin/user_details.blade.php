                ...
                <div class="data-details ">
                    <div class="row m-1">
                        <div class="fake-class">
                            ...
                            <span class="data-details-info large">{!! ($user->tableUserBalance()) !!}</span>
                        </div>
                    </div><br />
                    <div class="row m-1 data-details d-md-flex">
                        <div class="fake-class">
                            <span class="data-details-title">Total Contributed</span>
                            <span class="data-details-info large">{{ number_format($user->getSumContributed()) }} <small>USD</small></span>
                        </div>
