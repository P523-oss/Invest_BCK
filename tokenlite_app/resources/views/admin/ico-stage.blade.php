        ...
        <div class="card content-area content-area-mh">
            <div class="card-innr">
                <div class="card-head d-flex justify-content-between align-items-center">
                    <h4 class="card-title mb-2  ">Available Stages for Token Symbol: {{ $token->token_symbol }}</h4>
                </div>
                ...
                <div class="row guttar-vr-30px">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="stage-item stage-card {{($token->actived_stage == $stage->id)?'stage-item-actived':'' }}">
                            <div class="stage-head">
                                <div class="stage-title">
                                    <h6>Stage Name
                                    @if((date('Y-m-d H:i:s') >= $stage->start_date) && (date('Y-m-d H:i:s') <= $stage->end_date) && ($token->actived_stage == $stage->id) && ($stage->status != 'paused'))
                                ...
                                <div class="stage-action">
                                    ...
                                    <div class="toggle-class dropdown-content dropdown-content-top-left">
                                        <ul class="dropdown-list">
                                            ...
                                            <li><a href="{{route('admin.stages.edit', [$stage->token_id, $stage->id])}}">Update Stage</a></li>

                                            @if($token->actived_stage != $stage->id)
