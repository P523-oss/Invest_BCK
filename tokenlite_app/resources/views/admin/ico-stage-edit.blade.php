...
@section('title', 'Token Sale Stage')
        ...
        <div class="card content-area">
            <div class="card-innr">
                <div class="card-head d-flex justify-content-between align-items-center">
                    <h4 class="card-title mb-0">Token Sale Stage Update</h4>
                    <div class="d-flex guttar-15px">
                        <div class="fake-class">
                            <span class="badge badge-lg badge-dim badge-lighter d-none d-md-inline-block">Sold: {{ number_format($ico->soldout, 2).' '. $token->token_symbol }}</span>
                        </div>
                        <div class="fake-class">
                        ...
                        <div class="fake-class">
                            <a href="{{route('admin.stages', $token->id)}}" class="btn btn-sm btn-auto btn-primary d-sm-inline-block d-none"><em class="fas fa-arrow-left"></em><span>Back</span></a>
                            <a href="{{route('admin.stages', $token->id)}}" class="btn btn-icon btn-sm btn-primary d-sm-none"><em class="fas fa-arrow-left"></em></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="tab-pane fade show active" id="ico_stage">
                        <form action="{{ route('admin.ajax.stages.update') }}" class="_reload validate-modern" method="POST" id="ico_stage" autocomplete="off">
                            ...
                            <div id="stageDetails" class="wide-max-md">
                                {{-- Stage Details Form --}}
                                <h4>Token Symbol: {{ $token->token_symbol }}</h4>
