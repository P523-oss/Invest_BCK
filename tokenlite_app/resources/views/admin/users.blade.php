                    ...
                    <div class="page-nav-bar justify-content-between bg-lighter">
                        <div class="page-nav w-100 w-lg-auto">
                            <ul class="nav">
                                ...
                                <li class="nav-item {{ (is_page('users.admin') ? ' active' : '') }}"><a class="nav-link" href="{{ route('admin.users', 'admin') }}">Admins / Supervisors</a></li>
                                ...
                                <div class="row align-items-end guttar-20px guttar-vr-15px">
                                    ...
                                    <div class="col-lg-4 col-sm-8 col-mb-6">
                                        <div class="input-wrap input-item-middle text-left">
                                            ...
                                            <label for="include-admin">Including Admin and Supervisors</label>
                                        </div>
                                    </div>
                    ...
                    <tbody>
                        ...
                        <tr class="data-item">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="fake-class">
                                        ...
                                        <span class="sub user-id">{{ set_id($user->id, 'user') }}
                                            ...
                                            <span class="badge badge-xs badge-dim badge-{{($user->type == 'demo')?'danger':(($user->role == 'admin')?'success':'primary')}}">{{ strtoupper ($user->role)}}</span>
                                            @endif
                                        </span>
                                    </div>
                                </div>
                            ...
                            <td class="data-col dt-token">
                                <span class="lead lead-btoken">{!! ($user->tableUserBalance("list")) !!}</span>
                            </td>
                                ...
                                <div class="relative d-inline-block">
                                    ...
                                    <div class="toggle-class dropdown-content dropdown-content-top-left">
                                        <ul class="dropdown-list more-menu-{{$user->id}}">
                                            ...
                                            <li><a href="{{route('admin.updateRole',['id'=> $user->id])}}"><em class="fa fa-users-cog"></em> Set As Client Admin</a></li>
