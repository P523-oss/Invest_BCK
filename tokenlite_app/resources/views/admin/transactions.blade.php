                    ...
                    <tbody>
                        ...
                        <tr class="data-item" id="tnx-item-{{ $trnx->id }}">
                            ...
                            <td class="data-col dt-token">
                                ...
                                <span class="sub sub-symbol">{{ $trnx->tnxToken->token_symbol }}</span>
                            </td>
                            <td class="data-col dt-amount">
                                ...
                                <span class="sub sub-symbol">{{ strtoupper($trnx->currency) }} <em class="fas fa-info-circle" data-toggle="tooltip" data-placement="bottom" title="1 {{ $trnx->tnxToken->token_symbol }} = {{ to_num($trnx->currency_rate, 'max').' '.strtoupper($trnx->currency) }}"></em></span>
                                @endif
                            </td>
                            <td class="data-col dt-usd-amount{{ $text_danger }}">
                                ...
                                <span class="sub sub-symbol">{{ strtoupper($trnx->base_currency) }} <em class="fas fa-info-circle" data-toggle="tooltip" data-placement="bottom" title="1 {{ $trnx->tnxToken->token_symbol }} = {{ to_num($trnx->base_currency_rate, 'max').' '.strtoupper($trnx->base_currency) }}"></em></span>
                                @endif
                            </td>
                            <td class="data-col dt-account">
                                ...
                                @else
                                    ...
                                    <span class="sub sub-email">{{ set_id($trnx->user) }} ({{ isset($trnx->tnxUser) ? explode_user_for_demo($trnx->tnxUser->email, auth()->user()->type) : '' }})</span> 
                                @endif
                            </td>
            ...
            <div class="popup-body popup-body-md">
                ...
                <form action="{{ route('admin.ajax.transactions.add') }}" method="POST" class="validate-modern" id="add_token" autocomplete="off">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="dropdown">
                                <h6 class="card-title mb-0">Token Symbol: 
                                    <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        {{ $token->token_symbol }}
                                    </button>
                                    <div class="dropdown-menu">
                                        @foreach($tokens as $tkn)
                                        <a class="dropdown-item" href="{{ route('admin.stages', $tkn->id) }}">{{$tkn->token_symbol }}</a>
                                        @endforeach
                                    </div>
                                </h6>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="input-item input-with-label">
                                ...
                                <div class="input-wrap">
                                    ...
                                    <input class="input-bordered" type="number" name="total_tokens" max="10000" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
