            ...
            <div class="main-content col-lg-12">
                <div class="content-area card">
                    <div class="card-innr">
                        ...
                        <p><em><strong>Note:</strong> The demo based on <a href="https://themeforest.net/item/ico-crypto-bitcoin-cryptocurrency-landing-page-html-template/21405614?rel=softnio">Token Sale Landing Page Template</a>, If you use this for your landing page, then we'll help you to integrate it free of charge.</em></p>
                        </div>
