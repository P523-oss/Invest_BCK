            ...
            <div class="card-innr">
                ...
                <ul class="data-details-list">
                    ...
                    <li>
                        ...
                        <div class="data-details-des">
                            ...
                            <span>{{ get_meta($trnx->extra, 'tokens').' '.$trnx->tnxToken->token_symbol }}</span>
                        </div>
                    </li>
                    @endif
                ...
                <ul class="data-details-list">
                    ...
                    <li>
                        ...
                        <div class="data-details-des">
                            <span>{{ to_num($trnx->tokens, 'min', '', false) }} {{ $trnx->tnxToken->token_symbol }}</span>
                        </div>
                    </li>
                    @endif
                    @if($trnx->tnx_type=='purchase')
                    <li>
                        ...
                        <div class="data-details-des">
                            <span>{{ to_num($trnx->total_bonus, 'min', '', false) }} {{ $trnx->tnxToken->token_symbol }}</span>
                    ...
                    <li>
                        ...
                        <div class="data-details-des">
                            <span><strong>{{ to_num($trnx->total_tokens, 'min', '', false) }} {{ $trnx->tnxToken->token_symbol }}</strong></span>
                            <span>(T+B)</span>
                        </div>
                    </li>
                    @endif
                    ...
                    <li>
                        ...
                        <div class="data-details-des">
                            <span><strong class="text-danger">{{ round($trnx->total_tokens, min_decimal()) }} {{ $trnx->tnxToken->token_symbol }}</strong></span>
                        </div>
                    </li>
                    @endif
